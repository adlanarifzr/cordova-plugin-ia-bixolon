...
typedef NS_OPTIONS(NSUInteger, __UPOS_PRINTER_BARCODE_SYMBOLOGIES) {
    ...
    PTR_BCS_DATAMATRIX   DEPRECATED_MSG_ATTRIBUTE("not USE") = 203,
...
typedef NS_OPTIONS(NSUInteger, __UPOS_PRINTER_STATUS) {
    ...
    PTR_SUE_COVER_OK                = 12,   // normal status
    PTR_SUE_JRN_COVER_OPEN          DEPRECATED_MSG_ATTRIBUTE("not USE") = 60,
    PTR_SUE_JRN_COVER_OK            DEPRECATED_MSG_ATTRIBUTE("not USE") = 61,
    PTR_SUE_REC_COVER_OPEN          DEPRECATED_MSG_ATTRIBUTE("not USE") = 62,
    PTR_SUE_REC_COVER_OK            DEPRECATED_MSG_ATTRIBUTE("not USE") = 63,
    PTR_SUE_SLP_COVER_OPEN          DEPRECATED_MSG_ATTRIBUTE("not USE") = 64,
    PTR_SUE_SLP_COVER_OK            DEPRECATED_MSG_ATTRIBUTE("not USE") = 65,

    PTR_SUE_JRN_EMPTY               DEPRECATED_MSG_ATTRIBUTE("not USE") = 21,
    PTR_SUE_JRN_NEAREMPTY           DEPRECATED_MSG_ATTRIBUTE("not USE") = 22,
    PTR_SUE_JRN_PAPEROK             DEPRECATED_MSG_ATTRIBUTE("not USE") = 23,

    PTR_SUE_REC_EMPTY               = 24,
    PTR_SUE_REC_NEAREMPTY           = 25,
    PTR_SUE_REC_PAPEROK             = 26,

    PTR_SUE_SLP_EMPTY               DEPRECATED_MSG_ATTRIBUTE("not USE") = 27,
    PTR_SUE_SLP_NEAREMPTY           DEPRECATED_MSG_ATTRIBUTE("not USE") = 28,
    PTR_SUE_SLP_PAPEROK             DEPRECATED_MSG_ATTRIBUTE("not USE") = 29,

    PTR_SUE_JRN_CARTRIDGE_EMPTY     DEPRECATED_MSG_ATTRIBUTE("not USE") = 41,
    PTR_SUE_JRN_CARTRIDGE_NEAREMPTY DEPRECATED_MSG_ATTRIBUTE("not USE") = 42,
    PTR_SUE_JRN_HEAD_CLEANING       DEPRECATED_MSG_ATTRIBUTE("not USE") = 43,
    PTR_SUE_JRN_CARTRIDGE_OK        DEPRECATED_MSG_ATTRIBUTE("not USE") = 44,

    PTR_SUE_REC_CARTRIDGE_EMPTY     DEPRECATED_MSG_ATTRIBUTE("not USE") = 45,
    PTR_SUE_REC_CARTRIDGE_NEAREMPTY DEPRECATED_MSG_ATTRIBUTE("not USE") = 46,
    PTR_SUE_REC_HEAD_CLEANING       DEPRECATED_MSG_ATTRIBUTE("not USE") = 47,
    PTR_SUE_REC_CARTRIDGE_OK        DEPRECATED_MSG_ATTRIBUTE("not USE") = 48,

    PTR_SUE_SLP_CARTRIDGE_EMPTY     DEPRECATED_MSG_ATTRIBUTE("not USE") = 49,
    PTR_SUE_SLP_CARTRIDGE_NEAREMPTY DEPRECATED_MSG_ATTRIBUTE("not USE") = 50,
    PTR_SUE_SLP_HEAD_CLEANING       DEPRECATED_MSG_ATTRIBUTE("not USE") = 51,
    PTR_SUE_SLP_CARTRIDGE_OK        DEPRECATED_MSG_ATTRIBUTE("not USE") = 52,

    PTR_SUE_REC_BATTERY_NORMAL      = 60,
    PTR_SUE_REC_BATTERY_LOW         = 61,

    PTR_SUE_IDLE                    DEPRECATED_MSG_ATTRIBUTE("not USE") = 1001
};
